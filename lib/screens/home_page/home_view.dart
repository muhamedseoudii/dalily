...
class HomePageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final CategoryController controller = Get.find()..fetchCategories();
    final TopItemController itemController = Get.find()..fetchItems();
    return Scaffold(
                        ...
                        return SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              TopItemData item =
                                  itemController.items[reverseIndex];
                              return SizedBox(
                                width: 180.w,
                                child: InkWell(
                                  onTap: () {
